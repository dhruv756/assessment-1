...
void main() 
{
    ...
    do 
    {
        ...
        switch (choice) 
        {
            case 1: total_amount += 180 * quantity; break;
            case 2: total_amount += 100 * quantity; break;
            case 3: total_amount += 120 * quantity; break;
            case 4: total_amount += 50 * quantity; break;
